...
export const Home = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://localhost:6060/task");
  ...
  const updateTask = async (id, editeddata) => {
    try {
      await fetch(`http://localhost:6060/task/${id}`, {
        method: "PATCH",
        headers: {
  ...
  const handleDelete = async (delId) => {
    try {
      await fetch(`http://localhost:6060/task/${delId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleChangeStatus = async (satId, event) => {
    try {
      ...
      await fetch(`http://localhost:6060/task/${satId}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
